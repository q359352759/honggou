...
export default {
  ...
  methods: {
    ...
    add_angentActivation() {
      var tishi =
        "恭喜您已成为代理人，成功获得价值198元的广告机套餐，在我的/广告套餐右上角点击激活。";
      ...
      this.$axios
        .post(
          "http://www.lxad.vip/api/add_angentActivation.php",
          this.$qs.stringify(obj)
        )
        .then(x => {
          console.log(x);
          mui.alert(
            x.data == true ? tishi : tishi1,
            "提示",
            () => {
    ...
    addguanggaoji() {
      var this_1 = this;
      var tishi =
        "恭喜您已成为代理人，成功获得价值198元的广告机套餐，点击公众号内的“广告管理”使用，初始账号为您的手机号，密码为手机号后6位，请在广告机内点击“会员服务”修改密码（请勿在红包乐购中修改）。";
      var tishi1 =
        "恭喜您已成为代理人，成功获得价值198元的广告机套餐，已经叠加到您的广告机账户。";
      var obj = {
    ...
    async add() {
      ...
      if (认证情况.data.code != 200) {
        mui.alert(
          认证情况.data.msg ? 认证情况.data.msg : 认证情况.data.message,
          "提示",
          "我知道了",
          function() {},
          "div"
    ...
    registered() {
      ...
      this.$axios({
        ...
        .then(x => {
          if (x.data.error) {
            mui.alert(
              x.data.message ? x.data.message : x.data.msg,
              "提示",
              "我知道了",
              function() {},
              "div"
