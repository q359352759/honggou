    ...
    <div class="支付成功">
        <ul>
            ...
            <li class="标题">
                ...
                <span>{{dingdanxiangqing.typeOne==1 ? '支付成功' : '取货成功'}}</span>
            </li>
            <li v-show="dingdanxiangqing.typeOne==1">
                <span>商家：</span>
                <b>{{dingdanxiangqing.shopName}}</b>
            </li>
            <li v-show="dingdanxiangqing.typeOne==1">
                <span>金额：{{dingdanxiangqing.paymentAmount+dingdanxiangqing.deduction}}元，省：{{dingdanxiangqing.deduction}}元</span>
            </li>
            <li v-show="dingdanxiangqing.typeOne==1">
                <span>实付：</span>
            ...
            <li class="按钮框">
                <!-- <btn @click.native="设置支付成功弹出框(false)" value="我知道了"/> -->
                <div @click="提交评论()">确定</div>
                <div @click="写评语()">写评语</div>
                <!-- <btn @click.native="提交评论()" :styles="{'width': '88px'}" value="确定"/>
                <btn @click.native="写评语()" :styles="{'width': '88px'}" value="写评语"/> -->
            </li>
        </ul>
    </div>
</template>
