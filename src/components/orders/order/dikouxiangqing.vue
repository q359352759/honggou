    ...
    <div class="box_3" v-show="dikouxiangqing_show">
        <div class="content_1">
                ...
                <div class="list">
                    <ul v-for="(item, index) in shangpin_dikou_list.shangpin_dikou_list" :key="index">
                        ...
                        <li>
                            ...
                            <div class="mui-text-center dikou">可省：{{item.deduction*item.number}}元</div>
                            <div class="mui-text-right money_1">省：{{item.dikou}}元</div>
                        </li>
                    </ul>
                </div>
                <div class="list" v-if="shangpin_dikou_list.qita_dikou_list.length!=0">
                    <ul v-for="(item, index) in shangpin_dikou_list.qita_dikou_list" :key="index">
                        ...
                        <li>
                            ...
                            <div class="mui-text-center dikou">可省：{{item.deduction*item.number}}元</div>
                            <div class="mui-text-right money_1">省钱：{{item.dikou}}元</div>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="footer_1">
                ...
                <div class="select_1">
                    <div>
                        <span v-if="qita_hongbao.length==0">未使用红包省钱</span>
...
export default {
  ...
  computed: {
    ...mapGetters({
      ...
      shangpin_dikou_list: "orders/order/shangpin_dikou_list", //省钱的详情
