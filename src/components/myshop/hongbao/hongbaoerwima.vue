            ...
            <div class="hong_box">
                ...
                <div class="text_1">
                    <div v-if="hongbao.type!=1">
                        ...
                        <span v-if="hongbao.deductionType==0">可省：{{hongbao.percentage}}元</span>
                    </div>
                    <div v-if="hongbao.type==1">
...
export default {
    ...
    methods: {
        ...
        start() {
            ...
            if (this.hongbao && this.hongbao.type != 1) {
                ...
                Promise.all([
                    ...
                    this.get_shangping_2(this.hongbao.commodityId)
                ]).then(x => {
                    console.log(x);
        ...
        //获取图片base64
        imgtobase64(imgurl) {
            console.log('网络图片地址转base64:'+imgurl)
