<template>
    <div>
        ...
        <div class="mui-content mui-fullscreen">
            ...
            <div class="box_3">
                <span>营业执照号：</span>
                <input type="text" v-model="店铺.blnumber" @blur="更新店铺key(['blnumber',店铺.blnumber])" placeholder="请输入营业执照号">
                <!-- <input type="text" v-model="店铺.blnumber" placeholder="请输入营业执照号"> -->
            </div>
        </div>
    ...
    methods: {
        ...
        input_change(e) {
            ...
            reader.onloadend = function () {
                ...
                this_1.set_myCanvas();
                // try {
                //     this_1.更新店铺key(["businessLicense", reader.result]);
                // } catch (error) {
                //     this_1.更新店铺key(["businessLicense", ""]);
        ...
        //删除图片
        async delete_1() {
            await this.更新店铺key(["businessLicense", ""]);
        }
    },
    mounted() {
