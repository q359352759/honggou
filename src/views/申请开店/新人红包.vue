        ...
        <div class="mui-content mui-fullscreen">
            ...
            <ul class="mui-table-view box_1">
                ...
                <li class="mui-table-view-cell item">
                    ...
                    <div class="input_1">
                        <input type="text" placeholder="请输入红包标题" v-model="新人红包.headline" @blur="更新红包key(['headline',新人红包.headline])">
                    </div>
                </li>
                <li class="mui-table-view-cell item">
                ...
                <li class="mui-table-view-cell item">
                    ...
                    <div class="input_1">
                        <input type="text" placeholder="请输入红包金额" v-model="新人红包.amount" @blur="更新红包key(['amount',新人红包.amount])">
                    </div>
            ...
            <ul class="mui-table-view box_1">
                <li class="mui-table-view-cell item">
                    ...
                    <span>可省支付金额的</span>
                    <div class="input_2">
                        <input type="text" v-model="新人红包.percentage" @blur="更新红包key(['percentage',新人红包.percentage])" />
                    </div>
                    <span>%</span>
                </li>
            </ul>
            ...
            <ul class="mui-table-view box_1">
                <li class="mui-table-view-cell item">
                    ...
                    <span>每满</span>
                    <div class="input_2">
                        <input type="text" v-model="新人红包.expire" @blur="更新红包key(['expire',新人红包.expire])">
                    </div>
                    <span>元，可省</span>
                    <div class="input_2">
                        <input type="text" v-model="新人红包.deduction" @blur="更新红包key(['deduction',新人红包.deduction])">
                    </div>
                    <div>元</div>
                </li>
            </ul>
            ...
            <ul class="box_2">
                ...
                <li>
                    2、可省百分比和满减规则只在用户直接输入支付金额付款时有效，用户选择商品购买时以商品的可省金额为准。
                </li>
            </ul>
    ...
    methods: {
        ...
        wenhao() {
            ...
            html =
                ...
                "<li>如：发放800元的红包，可省方式为“可省支付金额的10%”。</li>" +
                '<li style="text-indent: 20px;margin:0px 0px 10px;">1、顾客输入金额，支付100元，可用红包可省10元。顾客还剩余790元的红包，可以下次购买时使用。</li>' +
                '<li style="text-indent: 20px;margin:0px 0px 10px;">2、顾客购买商品，该商品设置的可省金额为20元，那么顾客购买时可以用红包可省20元。顾客还剩余780元的红包，可以下次购买时使用。</li>' +
        ...
        Sure() {
            ...
            try {
                ...
                if(this.新人红包.percentage){
                    this.新人红包.percentage = this.新人红包.percentage.replace(/\s+/g, "");
                }
                if(this.新人红包.expire){
                    this.新人红包.expire = this.新人红包.expire.replace(/\s+/g, "");
                }
                if(this.新人红包.deduction){
                    this.新人红包.deduction = this.新人红包.deduction.replace(/\s+/g, "");
                }                
            } catch (error) { }
            ...
            if (!this.新人红包.headline) {
                ...
                !number_test.test(this.新人红包.amount) || this.新人红包.amount < 0 ) {
                mui.toast("红包金额有误:" + this.新人红包.amount + ".", {
                    duration: 2000,
                    type: "div"
                });
                return;
