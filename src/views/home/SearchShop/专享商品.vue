<template>
    <div>
        <ul class="专享">
            <li v-for="(item, index) in 专享.list" :key="index" @tap="CommodityDetails_1(item)">
                <div class="img_box">
                    <img vi-f="item.comImg.split(',').length>0" :src="item.comImg.split(',')[0]" alt="" srcset="">
                </div>
                <div class="text_box">
                    <div>
                    ...
                    <div class="dikou">
                        ...
                        <span>省：{{item.comDeduction}}元</span>
                    </div>
                </div>
