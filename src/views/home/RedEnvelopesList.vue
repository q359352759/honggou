                    ...
                    <div>
                        <div class="cont_1">
                            ...
                            <div class="footer_1" v-if="redenvelope_0.list.length>0">
                                <span v-if="redenvelope_0.list[0].deductionType==1">满{{redenvelope_0.list[0].expire}}，省{{redenvelope_0.list[0].deduction}}元</span>
                                <span v-if="redenvelope_0.list[0].deductionType!=1">省&nbsp;{{redenvelope_0.list[0].percentage}}%</span>
                            </div>
                        </div>
                    </div>
                </li>
...
export default {
    ...
    methods: {
        ...
        //进店
        jindian() {
            this.$router.push("/sjzst2?shopid=" + this.shopid);
        },
        //查询各种红包
        get_redenvelope(obj) {
        ...
        content_scroll(e) {
            ...
            if (
                h + t >= sh - 10 &&
                !this.redenvelope_1.loading &&
                this.redenvelope_1.list.length < this.redenvelope_1.total
            ) {
