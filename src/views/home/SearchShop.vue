    ...
    <div>
        ...
        <div class="mui-content mui-fullscreen">
            <div class="box_1" :class="{'active':search_box}">
                ...
                <ul class="box_3">
                    <li :class="{'active':type==0}" @click="选择类型(0)">店铺街</li>
                    <li :class="{'active':type==3}" @click="选择类型(3)">特惠专享</li>
                    <li :class="{'active':type==1}" @click="选择类型(1)">同城购</li>
            ...
            <ul class="box_6" v-if="type==0" @scroll="content_scroll($event)">
                <li v-for="(item, index) in shop.list" :key="index">
                    ...
                    <div>
                        ...
                        <h2>
                            <span @click="weixinmaptest(item)" class="mui-pull-right"><i class="icon iconfont icon-location"></i>{{item.distance | filter_juli }}</span>
    ...
    methods: {
        ...
        get_shops() {
            ...
            if (this.screen_type == 2 || this.screen_type == 3) {
                ...
                delete this.shop.jquery.popularity
                delete this.shop.jquery.scoreAvg
                ...
                delete this.shop.jquery.distance
                delete this.shop.jquery.scoreAvg
                ...
                // this.shop.jquery.order = "scoreAvg";
                delete this.shop.jquery.distance
                delete this.shop.jquery.popularity
            ...
            // this.shop.jquery.
            this.$axios({method: "get",url: "/api-s/shops/findAll",params: this.shop.jquery}).then(x => {
        ...
        get_commodity() {
            ...
            if (this.screen_type == 2 || this.select_type == 3) {
                ...
                this.commodity.jquery.orderType = this.screen_type == 6 ? "ASC" : "DESC";
                this.commodity.jquery.order = "scoreAvg";
            }
            this.commodity.loading = true;

            api_获取商品列表(this.commodity.jquery).then(x=>{
        ...
        select_screen(x) {
            ...
            if (this.type == 0) {
                ...
                if (this.screen_type == 0 || this.screen_type == 1) {
                    ...
                    排序类型 = "scoreAvg";
                    排序方式 = this.screen_type == 6 ? "ASC" : "DESC";
                }
