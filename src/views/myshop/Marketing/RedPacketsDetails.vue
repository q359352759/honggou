            ...
            <div class="box_1">
                <div>
                    ...
                    <ul v-if="type==0 || type==5">
                        ...
                        <li>
                            <span v-if="Red_envelopes.deductionType==0" class="mui-pull-right">可省{{Red_envelopes.percentage}}%</span>
                            <span v-if="Red_envelopes.deductionType==1" class="mui-pull-right">每满{{Red_envelopes.expire}}元，省{{Red_envelopes.deduction}}元</span>
                        ...
                        <li>
                            <div>
                                <div class="text_1 mui-pull-right">
                                    <span v-if="Red_envelopes.deductionType==0">可省{{Red_envelopes.percentage}}%</span>
                                    <span v-if="Red_envelopes.deductionType==1">每满{{Red_envelopes.expire}}元，省{{Red_envelopes.deduction}}元</span>
                                </div>                                
