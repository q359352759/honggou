        ...
        <div class="mui-content mui-fullscreen" >
            ...
            <div class="列表1">
                <ul class="mui-table-view">
                    ...
                    <li class="mui-table-view-cell">
                        <a class="mui-navigate-right item" @click="$router.push('/myshop/shangping/guanli?back=1')">
                            <div class="标题">
                                商品列表：
                            </div>
    ...
    methods: {
        ...
        async 提交(){
            ...
            if(this.新cbonum.length==0 && this.自定义业务.length==0){
                ...
                return
            }else if(!this.招募信息.mincommissionscale || !zhengshu_test.test(this.招募信息.mincommissionscale) || this.招募信息.mincommissionscale<1 || this.招募信息.mincommissionscale>50){
                mui.toast('分佣比例须为1-50整数',{ duration: "long", type: "div" })
                return                
            }
            console.log('可以提交');
