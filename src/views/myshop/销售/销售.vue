<template>
    <div>
        ...
        <div class="mui-content mui-fullscreen" @scroll="scroll($event)">
            ...
            <div class="box_2">
                <div>
                    <sort :type="sort.type" :sortType="sort.sortType" :list="sort.list" @setSort="get_sort" />
                </div>
                <div>
...
export default {
        ...
        return {
            ...
            obj: {
                ...
                query: {
                    ...
                    startTime: "",
                    endTime: "",
                    order: "t.createTime", //时间 t.createTime 金额 t.turnover
    ...
    methods: {
        ...
        orderDetails(item) {
            ...
            this.$router.push("/myshop/xiaoshou/orderDetails?id=" + item.ordersid);
        },
        //接收排序参数
        get_sort(x) {
            console.log(x);
            ...
            this.obj.query.order =
                x.type == 1 ? "t.createTime" : "t.turnover";
        ...
        get_time(x) {
            ...
            if (x.type == 0) {
                ...
                this.obj.query.endTime =
                    x.end_year + "-" + x.end_month + "-" + x.end_day;
            } else {
                this.obj.query.startTime = x.year + "-" + x.month + "-" + x.day;
                if (x.end_year) {
                    this.obj.query.endTime =
        ...
        scroll(e) {
            ...
            if (
                h + t >= sh - 10 &&
                !this.obj.loading &&
                this.obj.total > this.obj.list.length
            ) {
                this.obj.page_index++;
                this.findAllShopOrders();
            }
        ...
        findAllShopOrders() {
            ...
            var query=Object.assign({}, this.obj.query);
            ...
            this.$axios
                .get("/api-s/shops/findAllShopOrders", { params: query })
                .then(x => {
                    console.log("获取列表", x);
                    if (x.data.code == 200) {
        ...
        //获取消费者用户信息
        get_user(item) {
            this.$axios("/api-u/users/findByUserid/" + item.userid)
                .then(x => {
