...
import sjxq from "./商家展示厅2/商家详情.vue";
import pinglun from './商家展示厅2/评论.vue';
import jianjie from './商家展示厅2/简介.vue';
import hblb from "./商家展示厅2/红包列表.vue";
import dgsp from "./商家展示厅2/单个商品.vue";
import gwc from "./商家展示厅2/购物车.vue";
...
export default {
    ...
    computed: {
        ...mapGetters({
            全部信息:'商家展示厅2/全部信息',
            环境图片:'商家展示厅2/环境图片',
            新人专享商品:'商家展示厅2/新人专享商品',
            生日专享商品:'商家展示厅2/生日专享商品',
            老顾客专享:'商家展示厅2/老顾客专享',
            新未分组商品:'商家展示厅2/新未分组商品',
            新人红包:"商家展示厅2/新人红包",
            红包可抵扣:'商家展示厅2/红包可抵扣',
        }),
        左侧高度(){
    ...
    methods: {
        ...mapActions({
            初始化:'商家展示厅2/初始化',
            评价下一页:'商家展示厅2/评价下一页',
            设置显示大图:'商家展示厅2/设置显示大图',
            添加和删除收藏:"商家展示厅2/添加和删除收藏",
            设置显示分享的红包:"商家展示厅2/设置显示分享的红包",
