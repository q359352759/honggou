        ...
        <div class="mui-content mui-fullscreen" >
            ...
            <div class="店铺信息">
                ...
                <ul class="左侧内容">
                    ...
                    <li class="人气">人气：{{招募信息.popularity ? 招募信息.popularity : 0}}</li>
                    <li class="招募">
                        <div class="招募进度">
...
import { api_根据id查询分销  ,api_获取自定义业务 } from "@/api/招募接口.js";
    ...
    methods: {
        ...
        获取商品(){
            var query={
                    start:0,
                    length:100,
                    shopid:this.招募信息.shopid,
                    state:1
                }
            api_获取商品列表(query).then(x=>{
                if(x.data.code==200){
        ...
        async 初始化(){
            openloading(true)
            await api_根据id查询分销(this.id).then(x=>{
                if(x.data.code==200){
                    this.招募信息=x.data.data;
                }
            })
            ...
            api_获取自定义业务(自定义业务_query).then(x=>{
                if(x.data.code==200){
                    this.自定义业务=x.data.data.data;
                }
            })
            this.获取商品();
            ...
            api_根据shopid查询店铺(this.招募信息.shopid).then(x=>{
                if(x.data.code==200){
                    this.店铺=x.data.data;
                    this.查询距离()
                }
