<template>
    <div id="RegionalAgent">
        ...
        <div class="mui-content">
            <ul class="box_1">
                <li class="img_box"  @click="$router.push('/SetUp')">
            ...
            <ul class="box_2">
                ...
                <li :class="{'active':type_1==4}" @click="change_type(4)">
                    ...
                    <div class="money">{{areaManager_obj.sutotal ? areaManager_obj.sutotal : 0}}</div>
                </li>
            </ul>
            <!-- 团队补贴-->
            ...
            <div class="content_1" v-show="type_1==2">
                ...
                <div class="kaifazhong">
                    <div class="imb_box"><img src="image/kaifazhong.png" alt=""></div>
    ...
    computed: {
        ...mapGetters({
            daiLiShang_fenrun_zichan:
                "agent/RegionalAgent/ShopBonus/daiLiShang_fenrun_zichan" //代理商 商家分润资产
        })
    },
    methods: {
        ...mapActions({
            get_daiLiShang_fenrun_zichan:
                "agent/RegionalAgent/ShopBonus/daiLiShang_fenrun_zichan" //获取代理商 商家分润资产
        }),
        返回上一页(){
            if(this.$route.query.block==1){
                history.back()
            }else if(this.$route.query.block=='my'){
                this.$router.push('/my')
            }else{
        ...
        subformanager(x) {
            x.loading = true;
            this.$axios.get("/api-u/users/subformanager?userid=" +this.userInfo.username +"&type=" +
                    x.type +
                    "&start=" +
