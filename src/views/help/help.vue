...
export default {
    ...
    methods: {
        ...
        scroll_1(e) {
            ...
            if (
                h + t >= sh - 10 &&
                this.qusetion.list.length < this.qusetion.total &&
                !this.qusetion.loading
            ) {
        ...
        get_questiontype() {
            this.$axios({
                method: "get",
                url: "/api-u/users/questiontype/findAll?start=0&length=4&state=1"
            })
                .then(x => {
        ...
        get_qusetion() {
            ...
            this.qusetion.query.start =
                this.qusetion.page_index * this.qusetion.query.length;
            this.$axios({
                method: "get",
