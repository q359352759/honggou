        ...
        <div class="mui-content">
            ...
            <div class="box_1">
                <ul class="mui-table-view">
                    ...
                    <li class="mui-table-view-cell " @click="$router.push('/shezhi/shdz')">
                        <a class="mui-navigate-right item_box">
                            <span>快递收货地址</span>
                        </a>
                    </li>
                    <li class="mui-table-view-cell " @click="$router.push('/shezhi/psdz')">
                        <a class="mui-navigate-right item_box">
                            <span>配送收货地址</span>
                        </a>
                    </li>
                    ...
                    <li class="mui-table-view-cell " v-if="是否通过审核">
                        <a class="mui-navigate-right item_box" @click="$router.push('/shezhi/zhujianshezhi')">
                            <span>主键设置</span>
                        </a>
                    </li>
                </ul>
            ...
            <div class="box_2">当前版本{{当前版本号}}</div>
